...
def run():
    ...
    with train_graph.as_default():
        ...
        train_model = BuildTrainModel(train_hparams.model_type,
    ...
    with dev_graph.as_default():
        ...
        dev_model = BuildEvalModel(train_hparams.model_type,
                                   hparams = dev_hparams,
    ...
    with test_graph.as_default():
        ...
        test_model = BuildInferModel(train_hparams.model_type,
