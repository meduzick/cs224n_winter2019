...
def get_train_hparams():
    ...
    train_files = Files(src_char_vcb_file = './data/vcbs/src_char_vcb.txt',
                        trg_char_vcb_file = './data/vcbs/trg_char_vcb.txt',
    ...
    return HParams(regime = 'TRAIN',
                   ...
                   chkpts_dir = './chkpts/',
                   trg_char_vcb_file = train_files.trg_char_vcb_file,
                   src_char_vcb_file = train_files.src_char_vcb_file,
                   kernel_size = 2,
                   word_emb_dim = 50,
                   stride = 1,
                   char_emb_dim = 50
...
def get_dev_hparams():
    ...
    dev_files = Files(src_char_vcb_file = './data/vcbs/src_char_vcb.txt',
                        trg_char_vcb_file = './data/vcbs/trg_char_vcb.txt',
                        trg_vcb_file = './data/vcbs/trg_vcb.txt',
                        src_train = './data/train/src.es',
                        trg_train = './data/train/trg.en',
    ...
    return HParams(regime = 'DEV',
                   ...
                   chkpts_dir = './chkpts/',
                   trg_char_vcb_file = dev_files.trg_char_vcb_file,
                   src_char_vcb_file = dev_files.src_char_vcb_file,
                   kernel_size = 2,
                   word_emb_dim = 50,
                   stride = 1,
                   char_emb_dim = 50
...
def get_test_hparams():
    ...
    test_files = Files(src_char_vcb_file = './data/vcbs/src_char_vcb.txt',
                        trg_char_vcb_file = './data/vcbs/trg_char_vcb.txt',
                        trg_vcb_file = './data/vcbs/trg_vcb.txt',
                        src_train = './data/train/src.es',
                        trg_train = './data/train/trg.en',
    ...
    return HParams(regime = 'TEST',
                   ...
                   num_units = 64,
                   learning_rate = 3e-04,
                   translation_file_path = './translations/word_translations.txt',
                   char_translation_file_path = './translations/char_translations.txt',
                   num_steps_to_eval = 500,
                   chkpts_dir = './chkpts/',
                   trg_char_vcb_file = test_files.trg_char_vcb_file,
                   src_char_vcb_file = test_files.src_char_vcb_file,
                   kernel_size = 2,
                   word_emb_dim = 50,
                   stride = 1,
                   char_emb_dim = 50
